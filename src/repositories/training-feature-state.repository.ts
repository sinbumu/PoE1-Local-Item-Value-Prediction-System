...
const TRAINING_FEATURE_CURSOR_KEY = "training_features_raw_cursor_v1";

export class TrainingFeatureStateRepository {
    ...
    await pool.query(
      `
        ...
        DO UPDATE SET
          ...
          updated_at = NOW()
      `,
      [TRAINING_FEATURE_CURSOR_KEY, JSON.stringify(cursor)],
    );
  }
